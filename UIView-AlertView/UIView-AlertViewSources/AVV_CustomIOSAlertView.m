...
@implementation AVV_CustomIOSAlertView
...
- (void)customIOS7dialogButtonTouchUpInside: (AVV_CustomIOSAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
...
//    dialogContainer.layer.borderColor = [UIColor redColor].CGColor;
